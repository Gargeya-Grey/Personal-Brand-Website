...
## Who you are (the full person)

You care about:

- knowing yourself
- how the mind actually works
- taking care of customers (you have done this for real)
...
If a day’s posts are all “grade the process,” we failed. That is only **two posts max per day**.
...
|--------|----------|------------|
| Small own tweets | **3** | 2–5 lines. Different parts of you. People should feel a bit better after. |
...
| Sitting | IST | What you post | Time |
|---------|-----|----------------|------|
| Morning | **11:30–12:30** | 2 replies + **1 small tweet** | 15 min |
| Evening | **19:00–20:30** | 2 replies + **2 small tweets** | 20 min |

19:00 is your best window (India evening, US morning starting).

---

## Reply or quote?

**Usually just reply.** That is how 170-follower accounts get seen.

**Once a day, only on a huge post:** quote with your thought, and if you also reply, the reply is **shorter and different**. Never the same text twice.

---

## This week’s own-tweets (rotate the person, not the slogan)

Scout: pick **three different parts** each day. Never three education.

| Day | Tweet 1 | Tweet 2 | Tweet 3 |
|-----|---------|---------|---------|
| Fri 14 | AI comfort (jobs / fear) | Care / customers | Positivity |
| Sat 15 | Optimism | Psychology | Empathy |
| Sun 16 | Rest, or quote your own best small tweet | Ethics / values | Self-awareness |
| Mon 17 | Self-awareness | Care / sales | Philosophy (short) |
...
- Both sittings, 5 of 7 days.
- A stranger who reads **only your last 6 tweets** feels a person, not a school brand.
- At least one AI-comfort tweet that a scared person would save.
- Zero follow-begs.

Followers: warmer account first. 170 → 250 is a strong week. 170 → 180 is fine if it sounds like you.

Bio: `reveal` → `reveals` when you have 10 seconds. Keep Edudojo.ai.
