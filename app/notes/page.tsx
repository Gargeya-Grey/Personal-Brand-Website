    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main id="page-main" tabIndex={-1} className="mx-auto w-full max-w-3xl flex-grow px-4 pb-20 pt-28 sm:px-6 sm:pb-24 sm:pt-32">
        ...
        <section className="mt-16">
          ...
          <div className="mt-8 max-h-[32rem] overflow-hidden font-body text-base leading-relaxed text-primary [mask-image:linear-gradient(to_bottom,black_70%,transparent)]">
