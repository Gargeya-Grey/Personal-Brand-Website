...
export default function BlogPage() {
  ...
  // Separate featured article (usually the first marked as featured, or the newest one)
      ...
      <div className="relative z-10 pt-52">
        ...
        <div className="px-6 md:px-12 max-w-screen-2xl mx-auto w-full pb-32">
          ...
          {filteredArticles.length === 0 ? (
            <div className="text-center py-24 bg-white dark:bg-white/[0.02] border border-emerald-500/20 dark:border-white/10 rounded-[2.5rem] p-8">
              ...
              <p className="font-body text-slate-500 dark:text-white/60 max-w-md mx-auto mt-2 text-sm">
                Try revising your filter categories or checking spelling in the search dashboard.
              </p>
            </div>
          ) : (
                    ...
                    <div className="lg:col-span-5 space-y-6">
                      <div className="flex flex-wrap gap-2">
                        {featuredPost.categories.map((c) => (
                          <span key={c} className="font-label text-[11px] uppercase tracking-wider font-bold text-accent bg-accent/10 px-2.5 py-0.5 rounded border border-accent/20">
                            {c}
                          </span>
                        ))}
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {regularPosts.map((post) => (
                    <Link 
                      ...
                      className="group flex flex-col justify-between p-5 rounded-[2rem] bg-white/72 dark:bg-white/[0.02] backdrop-blur-[28px] border border-accent/20 dark:border-white/10 shadow-[0_12px_24px_rgba(16,185,129,0.06)] dark:shadow-[0_10px_30px_-10px_rgba(0,0,0,0.2),_inset_0_2px_1px_rgba(255,255,255,0.15)] hover:border-accent/50 dark:hover:border-white/20 hover:shadow-[0_16px_32px_rgba(16,185,129,0.12)] dark:hover:shadow-[0_10px_30px_rgba(16,185,129,0.15),_inset_0_2px_1px_rgba(255,255,255,0.15)] hover:-translate-y-1 transition-all duration-300 ease-out"
                    >
                      <div className="space-y-5">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {post.categories.map((c) => (
                            <span key={c} className="font-label text-[10px] uppercase tracking-wider font-semibold text-accent bg-accent/10 px-2.5 py-0.5 rounded border border-accent/20">
                              {c}
                            </span>
                          ))}
                        </div>
